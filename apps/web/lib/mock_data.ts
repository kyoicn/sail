...
// --- Region Definitions ---
export const PREDEFINED_AREAS: Record<string, [number, number][]> = {
...
export const MOCK_EVENTS: EventData[] = [
  ...
  },
  {
    ...
    location: { lat: 32.5363, lng: 44.4208, placeName: 'Babylon', granularity: 'area', certainty: 'definite', customRadius: 5000, areaId: 'babylon_region' },
  ...
  },
  {
    ...
    location: { lat: 41.8902, lng: 12.4922, placeName: 'Rome', granularity: 'area', certainty: 'approximate', areaId: 'italy' },
  ...
  },
  {
    ...
    location: { lat: 34.0, lng: 44.0, placeName: 'Macedon Empire', granularity: 'area', certainty: 'definite', customRadius: 2000000 },
  ...
  },
  {
    ...
    location: { lat: 40.4319, lng: 116.5704, placeName: 'China', granularity: 'area', certainty: 'definite', areaId: 'china_heartland' },
  ...
  // --- MIDDLE AGES & RENAISSANCE ---
  {
    ...
    location: { lat: 41.9028, lng: 12.4964, placeName: 'Rome', granularity: 'area', certainty: 'definite', areaId: 'italy' },
  ...
  },
  {
    ...
    location: { lat: 24.1167, lng: -74.4667, placeName: 'Bahamas', granularity: 'area', certainty: 'definite' },
  ...
  // --- MODERN ERA (Clustering Test) ---
  {
    ...
    location: { lat: 39.9489, lng: -75.1500, placeName: 'Philadelphia, USA', granularity: 'area', certainty: 'definite', areaId: 'usa_east' },
  ...
  },
  {
    ...
    location: { lat: 36.2048, lng: 138.2529, placeName: 'Japan', granularity: 'area', certainty: 'definite', customRadius: 500000 },
  ...
  },
  {
    ...
    location: { lat: 50.0, lng: 10.0, placeName: 'Europe', granularity: 'area', certainty: 'definite', areaId: 'europe' },
  ...
  },
  {
    ...
    location: { lat: 34.3853, lng: 132.4553, placeName: 'Hiroshima, Japan', granularity: 'area', certainty: 'definite' },
  ...
  },
  {
    ...
    location: { lat: 52.5163, lng: 13.3777, placeName: 'Berlin, Germany', granularity: 'area', certainty: 'definite' },
