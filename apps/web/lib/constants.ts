...
export const MOCK_EVENTS: EventData[] = [
  ...
  },
  {
    ...
    location: { lat: 32.5363, lng: 44.4208, placeName: 'Babylon', granularity: 'area', certainty: 'definite', customRadius: 5000, regionId: 'babylon_region' },
  ...
  },
  {
    ...
    location: { lat: 41.8902, lng: 12.4922, placeName: 'Rome', granularity: 'area', certainty: 'approximate', regionId: 'italy' },
  ...
  },
  {
    ...
    location: { lat: 40.4319, lng: 116.5704, placeName: 'China', granularity: 'area', certainty: 'definite', regionId: 'china_heartland' },
  ...
  // --- MIDDLE AGES & RENAISSANCE ---
  {
    ...
    location: { lat: 41.9028, lng: 12.4964, placeName: 'Rome', granularity: 'area', certainty: 'definite', regionId: 'italy' },
  ...
  // --- MODERN ERA (Clustering Test) ---
  {
    ...
    location: { lat: 39.9489, lng: -75.1500, placeName: 'Philadelphia, USA', granularity: 'area', certainty: 'definite', regionId: 'usa_east' },
  ...
  },
  {
    ...
    location: { lat: 50.0, lng: 10.0, placeName: 'Europe', granularity: 'area', certainty: 'definite', regionId: 'europe' },
