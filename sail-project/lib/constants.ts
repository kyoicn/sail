...
export const MOCK_EVENTS: EventData[] = [
  ...
  { 
    ...
    start: { year: 1945, month: 8, day: 6, precision: 'day' }, 
  ...
  { id: 'dummy-1', title: 'Local Art Fair', start: { year: 2024 }, location: { lat: 48.8566, lng: 2.3400, placeName: 'Paris 1', granularity: 'spot', certainty: 'definite' }, summary: 'Minor local event.', imageUrl: '', sources: [], importance: 2 },
  { id: 'dummy-2', title: 'Metro Construction', start: { year: 2024 }, location: { lat: 48.8600, lng: 2.3500, placeName: 'Paris 2', granularity: 'spot', certainty: 'definite' }, summary: 'Minor local event.', imageUrl: '', sources: [], importance: 2 },
  { id: 'dummy-3', title: 'Cafe Opening', start: { year: 2024 }, location: { lat: 48.8500, lng: 2.3600, placeName: 'Paris 3', granularity: 'spot', certainty: 'definite' }, summary: 'Minor local event.', imageUrl: '', sources: [], importance: 2 },
  { id: 'dummy-4', title: 'Park Renovation', start: { year: 2024 }, location: { lat: 48.8700, lng: 2.3300, placeName: 'Paris 4', granularity: 'spot', certainty: 'definite' }, summary: 'Minor local event.', imageUrl: '', sources: [], importance: 2 },
];