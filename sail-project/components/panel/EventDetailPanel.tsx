      ...
      <div className="flex-grow overflow-y-auto p-6 space-y-6">
        ...
        <div>
            ...
            <p className="text-slate-700 leading-relaxed mt-4">
                (This area would contain a much longer description fetched from a database or Wikipedia API in a real production environment. For now, it demonstrates the scrollable layout of the sidebar.)
            </p>
        </div>
